            ...
            <div className="lg:col-span-2 flex flex-col items-center justify-center p-8 glass-panel h-full relative overflow-hidden">
                {videoInfo ? (
                    <div className="w-full max-w-2xl flex flex-col items-center z-10 animate-fade-in">
                        ...
                        <div className={`relative mb-10 transition-all duration-500`}>
                            ...
                            <div className={`absolute -inset-1 rounded-full ${isPlaying ? 'bg-gradient-to-r from-red-500 via-yellow-500 to-blue-500 animate-rainbow bg-[length:200%_200%]' : 'bg-surface-hover'}`} />
                            
                            {/* Spinning Record */}
                            <div className={`relative w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl ${isPlaying ? 'animate-spin-slow' : ''}`}>
                                <img 
                        ...
                        <div className="w-full max-w-lg mb-6 px-4">
                            ...
                            <input 
                                ...
                                onTouchEvent={() => setIsDragging(true)}
                                onTouchEnd={() => setIsDragging(false)}
                                className="w-full h-1 bg-surface-hover rounded-lg appearance-none cursor-pointer accent-red-500 hover:h-2 transition-all"
                            />
                        </div>

                        {/* Controls */}
                        <div className="flex items-center gap-8 mb-8">
                            <button className="p-4 text-text-secondary hover:text-text-primary transition-colors">
                            ...
                            <button 
                                ...
                                className={`w-20 h-20 rounded-full flex items-center justify-center text-3xl shadow-lg transition-all ${
                                    playerReady 
                                    ? 'bg-red-600 hover:bg-red-500 hover:scale-105 hover:shadow-red-500/40 text-white' 
                        ...
                        {/* Volume */}
                        <div className="flex items-center gap-4 w-full max-w-xs px-4 py-3 bg-surface rounded-full backdrop-blur-sm border border-border-color">
                            ...
                            <input 
                                ...
                                className="flex-1 h-1.5 bg-surface-hover rounded-lg appearance-none cursor-pointer accent-red-500"
                            />
                        </div>
                    </div>
                ) : (
                ...
                {videoInfo && (
                    <div className="absolute inset-0 z-0">
                        <img src={videoInfo.thumbnailUrl} className="w-full h-full object-cover blur-3xl opacity-30" />
