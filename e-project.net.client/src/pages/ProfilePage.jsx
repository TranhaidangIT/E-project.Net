        ...
        <Layout>
            <div className="profile-page">
                <div className="profile-header">
                    ...
                    <p className="profile-desc">Quản lý thông tin cá nhân của bạn</p>
                </div>
                <div className="profile-content">
                    ...
                    {!editing ? (
                        <div className="profile-info">
                            <div className="info-item"><label>Tên đăng nhập</label><span>{user.username}</span></div>
                            <div className="info-item"><label>Email</label><span>{user.email}</span></div>
                            <div className="info-item"><label>Họ tên</label><span>{user.fullName || 'Chưa cập nhật'}</span></div>
                            <div className="info-item"><label>Ngày tạo</label><span>{new Date(user.createdAt).toLocaleDateString('vi-VN')}</span></div>
                            ...
                            <div className="button-group">
                                {user.isAdmin && (<Link to="/admin" className="btn-primary">Quản trị</Link>)}
                                <button onClick={() => {
                                    setFormData({
                                        fullName: user.fullName || '',
                                        avatarURL: user.avatarURL || '',
                                    ...
                                    setEditing(true);
                                }} className="btn-secondary">Chỉnh sửa</button>
                                <Link to="/change-password" className="btn-warning">Đổi mật khẩu</Link>
